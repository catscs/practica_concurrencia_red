...
class AppCoordinator: Coordinator {
    ...
    override func start() {
        ...
        let userCorrdinator = UserCoordinator(presenter: userNavigationController, userDataManger: dataManager, userDetailDataManager: dataManager)
        addChildCoordinator(userCorrdinator)
        userCorrdinator.start()
        ...
        tabBarController.tabBar.items?[2].image = UIImage(systemName: "person.fill.badge.plus")
